...
if __name__ == '__main__':
    icse = ('ICSE2020ToRepair.xlsx', 'ICSE2020',
            f'time/time{sys.argv[2]}/ICSE2020DescendingOrderTime.xlsx')
    so = ('StackOverflow.xlsx', 'StackOverflow',
          f'time/time{sys.argv[2]}/StackOverflowDescendingOrderTime.xlsx')
    ...
    data.to_excel(dataset[2], index=False)
